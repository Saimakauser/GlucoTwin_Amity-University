...
## 16. Required Submission Documents

### Architecture Diagram
The system architecture diagram is provided in both PDF and PowerPoint formats:

- [Architecture Diagram – PDF](docs/architecture.pdf)
- [Architecture Diagram – PowerPoint](docs/architecture.pptx)

### Project Presentation
The complete project presentation is provided in PowerPoint format:

- [GlucoTwin Project Presentation – PPTX](presentation/GlucoTwin_Pitch_Deck.pptx)